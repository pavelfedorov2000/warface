...
const BackButton = () => {
    ...
    return (
        <button onClick={goBack} className="back-button" type="button" aria-label="Back to previous page">
            <svg className="back-button__arrow" viewBox="0 0 26 16" fill="none" xmlns="http://www.w3.org/2000/svg">
